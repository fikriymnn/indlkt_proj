...
class CobaTabel extends StatefulWidget {
  const CobaTabel({Key? key}) : super(key: key);

  @override
  State<CobaTabel> createState() => _CobaTabelState();
}

class _CobaTabelState extends State<CobaTabel> {
  List<Users> userList = [];
