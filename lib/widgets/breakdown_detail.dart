...
class BreakdownDetailForm extends StatefulWidget {
  final int index;

  const BreakdownDetailForm({super.key, required this.index});

  @override
  State<BreakdownDetailForm> createState() => _BreakdownDetailFormState();
}

class _BreakdownDetailFormState extends State<BreakdownDetailForm> {
  var form = BreakdownDetail().form;
  var form2 = BreakdownDetail().form2;
  var form3 = BreakdownDetail().form3;
...
class BreakdownDetail {
  ...
  Widget breakdownDetail(index) {
    return BreakdownDetailForm(index: index + 1);
  }
}
